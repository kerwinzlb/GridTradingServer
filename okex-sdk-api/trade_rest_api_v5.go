...
*/
func (client *Client) PostTradeBatchOrders(orderInfos *[]map[string]string) (*map[string]interface{}, error) {
	r := map[string]interface{}{}
	if _, err := client.Request(POST, TRADE_BATCH_ORDERS, orderInfos, &r); err != nil {
		return nil, err
	}
	return &r, nil
}
...
*/
func (client *Client) PostTradeCancelOrder(instId, ordId, clOrdId string) (*map[string]interface{}, error) {
	r := map[string]interface{}{}
...
*/
func (client *Client) PostTradeCancelBatchOrders(orderInfos *[]map[string]string) (*map[string]interface{}, error) {
	r := map[string]interface{}{}
	if _, err := client.Request(POST, TRADE_CANCLE_BATCH_ORDERS, orderInfos, &r); err != nil {
		return nil, err
	}
	return &r, nil
}
...
*/
func (client *Client) GetTradeOrder(instId, ordId, clOrdId string) (*map[string]interface{}, error) {
	r := map[string]interface{}{}

	req := NewReqParams()
	req.AddParam("instId", instId)
	req.AddParam("ordId", ordId)
	req.AddParam("clOrdId", clOrdId)
	url := BuildParams(TRADE_ORDER, req.Params())
